...
Untuk langkah pertama pastinya buat terlebih dahulu node untuk clusternya langkahnya sama saja seperti push based,baca terlebih dahulu bagian setup kvm/qemu sampai selesai hingga
domain/node sudah berjalan dan sudah siap,lalu baca bagian installasi dan configurasi k8s pake ansible sampai cluster berjalan,[baca disini]([ini](https://rizkiyusupk.github.io/devops/kubernetes/linux/server/iac/infrastructure/kvm/)),jika sudah masuk ke bagian 
