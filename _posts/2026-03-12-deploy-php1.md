...
cari pipeline yang sebelumnya sudah di buat dan jika belum maka bisa mengikuti tutorial di [sini](/https://rizkiyusupk.github.io/devops/kubernetes/linux/server/hybird-ci-cd/) 
nah bisa langsung di scroll saja ke bagian setup webhook disana juga suda ada step by step cara membuat pipeline,langsung saja masuk ke pipeline
yang sudah di buat jika sudah maka bisa langsung lihat output dari si build pipeline nya contohnya seperti ini

![ajdgaud](/assets/images/php1/Screenshot 2026-03-14 140801.png)

jika sudah kamu bisa cek hasil deploymentnya dengan masuk ke master terlebih dahulu lalu cari di worker mana si deployment berjalan
gunakan command 
...
command diatas merupakan untuk mengecek pod dan dimana pod itu berjalan kurang lebih outputnya seperti ini

![asdih](/assets/images/php1/Screenshot 2026-03-14 145033.png)

jika sudah langsung bisa akses lewat browser

![asidhasd](/assets/images/php1/Screenshot 2026-03-12 215953.png)

yeayyy sudah berhasil jika sudah seperti diatas maka kita sudah mempraktekan Ci/Cd deployment
