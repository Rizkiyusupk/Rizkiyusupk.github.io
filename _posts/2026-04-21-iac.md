...
|
[master]
node1 ansible_host=192.168.1.126

[slave1]
node2 ansible_host=192.168.1.127

[slave2]
node3 ansible_host=192.168.1.128
...
di ansible config inventory sudah di tentukan pathnya maka user harus membuat inventory sesuai dengan yang ada di ansible config4
